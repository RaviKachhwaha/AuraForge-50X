    ...
    <style>
        ...
        * {
        ...
        .sci-slider::-webkit-slider-thumb {
            ...
            background: var(--neon-cyan);
            cursor: pointer;
            box-shadow: 0 0 18px var(--neon-cyan), inset 0 0 6px #fff;
...
<body>
    ...
    <main class="main-container">
            ...
            <div class="card-grid">
                ...
                <div class="sci-card">
                    ...
                    <div class="knob-container">
                        <div class="radial-progress" id="radial-vol-bg">
                            <div class="radial-inner">
                                <div class="radial-val" id="val-vol-text">80%</div>
                                <div class="radial-unit">MASTER VOLUME</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sci-card">
                    ...
                    <div class="sci-switch-row">
                        <span>Dynamic Sub-Bass Enhancer</span>
                        <label class="sci-toggle">
                            <input type="checkbox" id="sw-dynbass" checked onchange="updateSetting('dynamicBassEnabled', this.checked)">
                    ...
                    <div class="sci-switch-row">
                        ...
                        <label class="sci-toggle">
                            <input type="checkbox" id="sw-mono" onchange="updateSetting('monoMode', this.checked)">
                            <span class="sci-slider-bg"></span>
                        </label>
                    </div>
                </div>
        ...
        <section id="tab-eq" class="tab-page">
            <div class="sci-card">
                ...
                <div class="eq-sliders-rack">
                    ...
                    <div class="eq-rack-col"><span>125Hz</span><input type="range" class="eq-v-slider" id="eq-2" min="-12" max="12" value="1" oninput="updateEqBand(2, this.value)"><span id="eqval-2" style="color: var(--neon-cyan); font-weight: 800;">1</span></div>
                    <div class="eq-rack-col"><span>250Hz</span><input type="range" class="eq-v-slider" id="eq-3" min="-12" max="12" value="0" oninput="updateEqBand(3, this.value)"><span id="eqval-3" style="color: var(--neon-cyan); font-weight: 800;">0</span></div>
                    <div class="eq-rack-col"><span>500Hz</span><input type="range" class="eq-v-slider" id="eq-4" min="-12" max="12" value="-1" oninput="updateEqBand(4, this.value)"><span id="eqval-4" style="color: var(--neon-cyan); font-weight: 800;">-1</span></div>
                    <div class="eq-rack-col"><span>1kHz</span><input type="range" class="eq-v-slider" id="eq-5" min="-12" max="12" value="0" oninput="updateEqBand(5, this.value)"><span id="eqval-5" style="color: var(--neon-cyan); font-weight: 800;">0</span></div>
                    <div class="eq-rack-col"><span>2kHz</span><input type="range" class="eq-v-slider" id="eq-6" min="-12" max="12" value="1" oninput="updateEqBand(6, this.value)"><span id="eqval-6" style="color: var(--neon-cyan); font-weight: 800;">1</span></div>
                    <div class="eq-rack-col"><span>4kHz</span><input type="range" class="eq-v-slider" id="eq-7" min="-12" max="12" value="2" oninput="updateEqBand(7, this.value)"><span id="eqval-7" style="color: var(--neon-cyan); font-weight: 800;">2</span></div>
                    <div class="eq-rack-col"><span>8kHz</span><input type="range" class="eq-v-slider" id="eq-8" min="-12" max="12" value="3" oninput="updateEqBand(8, this.value)"><span id="eqval-8" style="color: var(--neon-cyan); font-weight: 800;">3</span></div>
                    <div class="eq-rack-col"><span>16kHz</span><input type="range" class="eq-v-slider" id="eq-9" min="-12" max="12" value="4" oninput="updateEqBand(9, this.value)"><span id="eqval-9" style="color: var(--neon-cyan); font-weight: 800;">4</span></div>
                </div>
            </div>
        </section>
        ...
        <section id="tab-drc" class="tab-page">
            <div class="card-grid">
                <div class="sci-card">
                    <div class="card-header"><span>Dynamic Range Compressor (DRC)</span></div>
                    <div class="sci-slider-group">
                        <div class="sci-label-row"><span>Compression Threshold</span><span id="val-drc-thresh" style="color: var(--neon-cyan);">-18.0 dB</span></div>
                        <input type="range" class="sci-slider" id="slide-drc-thresh" min="-40" max="0" value="-18" oninput="updateDrc()">
                    </div>
                    <div class="sci-slider-group">
                ...
                <div class="sci-card">
                    <div class="card-header"><span>Subwoofer & Subsonic Crossover</span></div>
                    <div class="sci-slider-group">
                        <div class="sci-label-row"><span>Subsonic High-Pass Cutoff</span><span id="val-hp-cutoff" style="color: var(--neon-cyan);">20 Hz</span></div>
                        <input type="range" class="sci-slider" id="slide-hp-cutoff" min="20" max="100" value="20" oninput="updateSetting('highPassCutoff', this.value)">
                    </div>
                    <div class="sci-slider-group">
                        <div class="sci-label-row"><span>Subwoofer Low-Pass Cutoff</span><span id="val-sub-cutoff" style="color: var(--neon-cyan);">150 Hz</span></div>
                        <input type="range" class="sci-slider" id="slide-sub-cutoff" min="60" max="250" value="150" oninput="updateSetting('subLowPassCutoff', this.value)">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="tab-visualizer" class="tab-page">
            <div class="card-grid">
                ...
                <div class="sci-card">
                    ...
                    <div class="sci-slider-group">
                        <div class="sci-label-row"><span>Target Frequency</span><span id="val-genfreq" style="color: var(--neon-cyan);">1000 Hz</span></div>
                        <input type="range" class="sci-slider" id="slide-genfreq" min="20" max="20000" value="1000" oninput="updateGen()">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="tab-system" class="tab-page">
            <div class="card-grid">
                ...
                <div class="sci-card">
                    <div class="card-header"><span>System Operations</span></div>
                    <button class="sci-btn sci-btn-outline" style="margin-bottom: 12px;" onclick="rebootDevice()">REBOOT BOARD</button>
                    <button class="sci-btn sci-btn-danger" onclick="resetDefaults()">FACTORY RESET NVS</button>
                </div>
            </div>
        </section>
    </main>
    ...
    <script>
        ...
        function switchTab(name) {
            ...
            document.querySelectorAll('.tab-page').forEach(c => c.classList.remove('active'));
        ...
        function updateEqBand(idx, val) {
            document.getElementById(`eqval-${idx}`).innerText = val;
        ...
        function updateGen() {
            let mode = parseInt(document.getElementById('gen-mode').value);
            let freq = parseFloat(document.getElementById('slide-genfreq').value);
            document.getElementById('val-genfreq').innerText = freq + ' Hz';
            if (ws && ws.readyState === WebSocket.OPEN) {
                ws.send(JSON.stringify({ genMode: mode, genFreq: freq }));
            }
        }

        function updatePowerProfile(val) {
            if (ws && ws.readyState === WebSocket.OPEN) {
                ws.send(JSON.stringify({ powerProfile: parseInt(val) }));
            }
        }
        ...
        function rebootDevice() {
            ...
            alert('Reboot command sent to AuraForge 50X.');
        }
